...
=======
col_fil = col
dreact<-reactiveValues(df=ipl,df_bat=batsmen,df_bowl=bowlers,col_fil=col,sz=.5,pt_sz=3,bwl_jitt_col="white")
>>>>>>> 11eeecc5bce837967e968bb1155c7449ecdbb9ea
...
renderPlotly({
gg<-ggplot(dreact$df_bowl,mapping= aes(label1=Player,label2=SR,label3=Wkts,label4=Econ,x=reorder(Player,Wkts,sum),y=Wkts))+
	geom_jitter(color=dreact$bwl_jitt_col, size=10) +
	geom_jitter(mapping=aes(fill=Team,size=1000/Econ))+
	 geom_segment(aes(x=Player, 
                   xend=Player, 
